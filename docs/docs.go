        ...
        "/api/v1/devices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by state (available, in-use, inactive)",
                        "name": "state",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/internal_device.Device"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_device.createRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/devices/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Device partial data",
                        "name": "device",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_device.patchRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "internal_device.Device": {
            ...
            "properties": {
                ...
                "state": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/internal_device.State"
                        }
                    ],
                    "example": "available"
                }
